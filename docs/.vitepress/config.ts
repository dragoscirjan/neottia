    ...
    nav: [
      ...
      },
      {
        ...
        items: [
          ...
          { text: 'Searchable', link: '/mcp/searchable' },
        ],
      },
      ...
      '/searchable/': [
        {
          text: 'Searchable',
          items: [
            { text: 'Overview', link: '/searchable/' },
            { text: 'Configuration', link: '/searchable/configuration' },
            { text: 'Providers', link: '/searchable/providers' },
            { text: 'Fetch and extraction', link: '/searchable/fetching' },
            { text: 'Stash and local search', link: '/searchable/stash-and-search' },
            { text: 'Grounded answers', link: '/searchable/asking' },
            { text: 'Tools', link: '/searchable/tools' },
            { text: 'Library', link: '/searchable/services' },
            { text: 'Migration', link: '/searchable/migration' },
            { text: 'Operations', link: '/searchable/operations' },
