...
Read the [Memory MCP guide](https://github.com/dragoscirjan/neottia/blob/main/docs/mcp/memory.md) and [unified configuration guide](https://github.com/dragoscirjan/neottia/blob/main/docs/configuration.md).
